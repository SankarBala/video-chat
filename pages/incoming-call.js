                                        ...
                                        <div className="chat-contents">
                                            <div className="chat-content-wrap">
                                                <div className="voice-call-avatar">
                                                    <img src="assets/img/user-03.jpg" alt className="call-avatar" />
                                                ...
                                                <div className="call-users">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href>
                                                                <img src="assets/img/user-05.jpg" className="img-fluid" alt />
                                                                <span className="call-mute"><i className="fa fa-microphone-slash" /></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href>
                                                                <img src="assets/img/user-06.jpg" className="img-fluid" alt />
                                                                <span className="call-mute"><i className="fa fa-microphone-slash" /></span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                            ...
                                                            <div className="table-content">
                                                                ...
                                                                <div className="chat-profile-info">
                                                                    <ul className="user-det-list">
                                                                        ...
                                                                        <li>
                                                                            <span>Email:</span>
                                                                            <span className="float-right text-muted"><a href="http://cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="8ae0e5e2e4eee5efcaeff2ebe7fae6efa4e9e5e7">[email&nbsp;protected]</a></span>
                                                                        </li>
                                                                        <li>
                                                                            <span>Phone:</span>
                            ...
                            <div className="modal-body">
                                <div className="profile-widget">
                                    <div className="profile-img">
                                        <a href="profile.html" className="avatar"><img src="assets/img/user-03.jpg" alt /></a>
                                    </div>
                                    <h4 className="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.html">Tressa Wexler</a></h4>
                                    <div className="small text-muted">calling ...</div>
                                    <div className="incoming-btns">
                                        <a href="chat.html" className="btn btn-success m-r-10">Decline</a>
                                        <a href="profile.html" className="btn btn-danger">Answer</a>
                                    </div>
                                </div>
                            </div>
                        </div>
