                                                        ...
                                                        <div className="table-content">
                                                            ...
                                                            <div className="chat-profile-info">
                                                                <ul className="user-det-list">
                                                                    ...
                                                                    <li>
                                                                        <span>Email:</span>
                                                                        <span className="float-right text-muted"><a href="http://cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="73191c1b1d171c1633160b121e031f165d101c1e">[email&nbsp;protected]</a></span>
                                                                    </li>
                                                                    <li>
                                                                        <span>Phone:</span>
